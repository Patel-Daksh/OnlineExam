...
<?php
  if (isset($_GET['editque'])) {
    $quesNo = (int)$_GET['editque'];
    $delresult = $exam->geteditquestion($quesNo);
  }
?>
                    ...
                    if ($questionData) {
                        ...
                        while ($result = $questionData->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td><a onclick="return confirm('Are you sure to Edit.')" href="?editque=<?php echo $result['quesNo']; ?>">Edit</a>
                                </td>
                            </tr>
                        <?php } } ?>
                    </tbody>
