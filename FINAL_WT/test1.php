...
<?php
 ...
 $question = $exam->getQuestionNumber1($quesnumber);

?>
<?php
 if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 	$Process = $pro->getProcessData1($_POST);
 }
            ...
            <div class="col-lg-12">
                <form method="post" action="">
                    <table>
                        ...
                        <?php
                        $answer = $exam->getAnswer1($quesnumber);
                        if ($answer) {
                            ...
                            <td>
								...
								<script>
								 function previous()
								 {
									 ...
									 {
									 window.location.href = "test1.php?q=<?php echo $question['quesNo']-1; ?>";
									 <?php //$pro->fixscore(); ?>
									 }
									 else
									 {
